...
import com.puttysoftware.mazerunner3.maze.objects.FireArrow;
import com.puttysoftware.mazerunner3.maze.objects.GhostArrow;
import com.puttysoftware.mazerunner3.maze.objects.IceArrow;
import com.puttysoftware.mazerunner3.maze.objects.PlainArrow;
import com.puttysoftware.mazerunner3.maze.objects.PoisonArrow;
import com.puttysoftware.mazerunner3.maze.objects.ShockArrow;
...
public class GameArrowTask extends Thread {
	...
	try {
		...
		app.getGameManager().redrawOneSquare(py + cumY, px + cumX, true, a);
		app.getGameManager().redrawOneSquare(py + cumY, px + cumX, false, new Empty());
		cumX += incX;
		cumY += incY;
		try {
		    o = m.getCell(px + cumX, py + cumY, pz, MazeConstants.LAYER_OBJECT);
