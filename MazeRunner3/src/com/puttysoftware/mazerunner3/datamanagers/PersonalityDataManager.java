 ...
 */
package com.puttysoftware.mazerunner3.datamanagers;
...
public class PersonalityDataManager {
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(PersonalityDataManager.class.getResourceAsStream(
		"/assets/data/personality/" + name + Extension.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
