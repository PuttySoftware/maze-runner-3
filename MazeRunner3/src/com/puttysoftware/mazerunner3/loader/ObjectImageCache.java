...
public class ObjectImageCache {
	...
	if (!ObjectImageCache.isInCache(name)) {
		...
		BufferedImageIcon bii1 = ObjectImageLoader.getUncachedImage(baseName);
		bii1 = ImageTransformer.templateTransformImage(bii1, transformColor);
		BufferedImageIcon bii2 = ObjectImageLoader.getUncachedImage(attrName);
		...
		BufferedImageIcon bii = ObjectImageLoader.getUncachedImage(baseName);
