...
public class PersonalityDataLoader {
	...
	try (final ResourceStreamReader rsr = new ResourceStreamReader(PersonalityDataLoader.class.getResourceAsStream(
		"/asset/data/personality/" + name + Extension.getInternalDataExtensionWithPeriod()))) {
	    // Fetch data
