...
public class NamesConstants {
    ...
    public static final String[] SECTION_ARRAY_EQUIP_SLOTS = new String[] { NamesConstants.SLOT_HELMET,
	    NamesConstants.SLOT_NECKLACE, NamesConstants.SLOT_MAIN_HAND, NamesConstants.SLOT_OFF_HAND,
	    NamesConstants.SLOT_ROBE, NamesConstants.SLOT_CAPE, NamesConstants.SLOT_SHIRT, NamesConstants.SLOT_BRACERS,
	    NamesConstants.SLOT_GLOVES, NamesConstants.SLOT_RING, NamesConstants.SLOT_BELT, NamesConstants.SLOT_PANTS,
