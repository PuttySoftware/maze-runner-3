...
public class XLegacyDataReader implements AutoCloseable {
    ...
    // Constructors
    public XLegacyDataReader(final String filename, final String newDocTag) throws IOException {
    ...
    public XLegacyDataReader(final InputStream stream, final String newDocTag) throws IOException {
	...
	if (line != null) {
	    ...
	    XLegacyDataReader.validateOpeningTag(split[0], XLegacyDataConstants.DOUBLE_TAG);
	    XLegacyDataReader.validateClosingTag(split[2], XLegacyDataConstants.DOUBLE_TAG);
	...
	if (line != null) {
	    final String[] split = XLegacyDataReader.splitLine(line);
	    XLegacyDataReader.validateOpeningTag(split[0], XLegacyDataConstants.INT_TAG);
	    XLegacyDataReader.validateClosingTag(split[2], XLegacyDataConstants.INT_TAG);
	...
	if (line != null) {
	    final String[] split = XLegacyDataReader.splitLine(line);
	    XLegacyDataReader.validateOpeningTag(split[0], XLegacyDataConstants.LONG_TAG);
	    XLegacyDataReader.validateClosingTag(split[2], XLegacyDataConstants.LONG_TAG);
	...
	if (line != null) {
	    final String[] split = XLegacyDataReader.splitLine(line);
	    XLegacyDataReader.validateOpeningTag(split[0], XLegacyDataConstants.BYTE_TAG);
	    XLegacyDataReader.validateClosingTag(split[2], XLegacyDataConstants.BYTE_TAG);
	...
	if (line != null) {
	    final String[] split = XLegacyDataReader.splitLine(line);
	    XLegacyDataReader.validateOpeningTag(split[0], XLegacyDataConstants.BOOLEAN_TAG);
	    XLegacyDataReader.validateClosingTag(split[2], XLegacyDataConstants.BOOLEAN_TAG);
	...
	if (line != null) {
	    final String[] split = XLegacyDataReader.splitLine(line);
	    XLegacyDataReader.validateOpeningTag(split[0], XLegacyDataConstants.STRING_TAG);
	    XLegacyDataReader.validateClosingTag(split[2], XLegacyDataConstants.STRING_TAG);
	    return split[1];
	} else {
	    throw new IOException("End of file!");
	}
