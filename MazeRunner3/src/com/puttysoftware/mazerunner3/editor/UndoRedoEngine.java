...
public class UndoRedoEngine {
    ...
    public void updateUndoHistory(final AbstractMazeObject obj, final int x, final int y, final int z, final int w,
	    final int e) {
	this.undoHistory.push(obj, x, y, z, w, e);
    }

    public void updateRedoHistory(final AbstractMazeObject obj, final int x, final int y, final int z, final int w,
	    final int e) {
	...
	public Link(final AbstractMazeObject obj, final int x, final int y, final int z, final int w, final int e) {
	    this.mo = obj;
	    this.coordX = x;
	    this.coordY = y;
	    this.coordZ = z;
	...
	public void insertFirst(final AbstractMazeObject obj, final int x, final int y, final int z, final int w,
		final int e) {
	...
	public void push(final AbstractMazeObject obj, final int x, final int y, final int z, final int w,
		final int e) {
