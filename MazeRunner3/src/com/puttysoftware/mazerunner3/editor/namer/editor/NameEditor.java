 ...
 */
package com.puttysoftware.mazerunner3.editor.namer.editor;
...
public class NameEditor extends AbstractObjectEditor {
    ...
    protected void loadObject() {
        this.cachedNames = Boot.getApplication().getScenarioManager()
                .getNamesFileManager().getNames();
    }

    @Override
    protected void saveObject() {
        Boot.getApplication().getScenarioManager().getNamesFileManager()
            ...
            try {
                ...
                if (cmd.equals("Edit Names")) {
                    ...
                    if (me.doesObjectExist()) {
                        ...
                        me.create();
                        Boot.getApplication().getScenarioManager()
