...
import com.puttysoftware.mazerunner3.creatures.characterfiles.CharacterRegistration;
...
import com.puttysoftware.mazerunner3.editor.namer.abc.AbstractEditor;
import com.puttysoftware.mazerunner3.game.InventoryViewer;
import com.puttysoftware.mazerunner3.game.NoteManager;
import com.puttysoftware.mazerunner3.game.PrestigeViewer;
import com.puttysoftware.mazerunner3.game.StatisticsViewer;
...
public class MenuManager {
    ...
    private JMenuItem gameObjectInventory, gameReset, gameEquipment, gameInventory, gamePickLeader,
	    gameRegisterCharacter, gameUnregisterCharacter, gameRemoveCharacter, gameEditNote, gameViewPrestige,
	    gameViewScore, gameViewStats, gameUseAnItem, gameSwitchBow;
	...
	this.battleSpellAccel = KeyStroke.getKeyStroke(KeyEvent.VK_L, modKey | InputEvent.SHIFT_DOWN_MASK);
	...
	this.battleEndTurnAccel = KeyStroke.getKeyStroke(KeyEvent.VK_E, modKey | InputEvent.SHIFT_DOWN_MASK);
    }
	...
	public void actionPerformed(final ActionEvent e) {
		...
		if (cmd.equals("New...")) {
		    ...
		    InventoryViewer.showObjectInventoryDialog(app.getGameManager().getObjectInventory());
		} else if (cmd.equals("Reset Current Level")) {
		    final int result = CommonDialogs
			    .showConfirmDialog("Are you sure you want to reset the current level?", "MazeRunnerII");
		    ...
		    app.getEditor().editTeleportDestination(MazeEditorLogic.TELEPORT_TYPE_FIRST_MOVING_FINISH);
