...
import com.puttysoftware.mazerunner3.maze.objects.Arrow;
...
class MapBattleArrowTask extends Thread {
    ...
    // Constructors
    MapBattleArrowTask(final int newX, final int newY, final int newAT, final MapBattleDefinitions defs) {
	this.x = newX;
	this.y = newY;
	this.at = newAT;
	this.bd = defs;
