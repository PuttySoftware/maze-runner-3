package com.puttysoftware.mazerunner3.battle.window;
...
public class WindowBattleLogic extends AbstractBattle {
	...
	return WindowBattleLogic.BASE_RUN_CHANCE
		- this.enemy.getLevelDifference() * WindowBattleLogic.RUN_CHANCE_DIFF_FACTOR;
    }

    final int computeEnemyRunChance() {
	return WindowBattleLogic.ENEMY_BASE_RUN_CHANCE
		+ this.enemy.getLevelDifference() * WindowBattleLogic.ENEMY_RUN_CHANCE_DIFF_FACTOR;
    }
