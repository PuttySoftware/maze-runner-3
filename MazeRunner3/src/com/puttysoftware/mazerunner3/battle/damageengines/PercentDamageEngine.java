 ...
 */
package com.puttysoftware.mazerunner3.battle.damageengines;
...
import com.puttysoftware.mazerunner3.items.Equipment;
import com.puttysoftware.mazerunner3.items.EquipmentSlotConstants;
...
class PercentDamageEngine extends AbstractDamageEngine {
	...
	if (this.fumble) {
		...
		if (rEvade < aEvade) {
			...
			rDamage = new RandomRange(PercentDamageEngine.MULTIPLIER_MIN,
		    ...
		    final Equipment hat = acting.getItems().getEquipmentInSlot(EquipmentSlotConstants.SLOT_HEAD);
		    if (hat != null) {
			for (int z = 0; z < fc; z++) {
		    ...
		    final Equipment necklace = acting.getItems().getEquipmentInSlot(EquipmentSlotConstants.SLOT_NECK);
		    if (necklace != null) {
			for (int z = 0; z < fc; z++) {
		    ...
		    final Equipment cape = acting.getItems().getEquipmentInSlot(EquipmentSlotConstants.SLOT_BACK);
		    if (cape != null) {
			for (int z = 0; z < fc; z++) {
		    ...
		    final Equipment shirt = acting.getItems()
			    .getEquipmentInSlot(EquipmentSlotConstants.SLOT_UPPER_TORSO);
		    if (shirt != null) {
			for (int z = 0; z < fc; z++) {
		    ...
		    final Equipment bracers = acting.getItems().getEquipmentInSlot(EquipmentSlotConstants.SLOT_ARMS);
		    if (bracers != null) {
			for (int z = 0; z < fc; z++) {
		    ...
		    final Equipment gloves = acting.getItems().getEquipmentInSlot(EquipmentSlotConstants.SLOT_HANDS);
		    if (gloves != null) {
			for (int z = 0; z < fc; z++) {
		    ...
		    final Equipment ring = acting.getItems().getEquipmentInSlot(EquipmentSlotConstants.SLOT_FINGERS);
		    if (ring != null) {
			for (int z = 0; z < fc; z++) {
		    ...
		    final Equipment belt = acting.getItems()
			    .getEquipmentInSlot(EquipmentSlotConstants.SLOT_LOWER_TORSO);
		    if (belt != null) {
			for (int z = 0; z < fc; z++) {
		    ...
		    final Equipment pants = acting.getItems().getEquipmentInSlot(EquipmentSlotConstants.SLOT_LEGS);
		    if (pants != null) {
			for (int z = 0; z < fc; z++) {
		    ...
		    final Equipment boots = acting.getItems().getEquipmentInSlot(EquipmentSlotConstants.SLOT_FEET);
		    if (boots != null) {
			for (int z = 0; z < fc; z++) {
