...
public class PoisonBomb extends AbstractBomb {
	...
	Game.getApplication().getMazeManager().getMaze().radialScanPoisonObjects(x, y, z, AbstractBomb.EFFECT_RADIUS);
	// Poison the ground, too
	Game.getApplication().getMazeManager().getMaze().radialScanPoisonGround(x, y, z, AbstractBomb.EFFECT_RADIUS);
    }
}
