...
public class FireBomb extends AbstractBomb {
	...
	Game.getApplication().getMazeManager().getMaze().radialScanEnrageObjects(x, y, z, AbstractBomb.EFFECT_RADIUS);
	// Burn the ground, too
	Game.getApplication().getMazeManager().getMaze().radialScanBurnGround(x, y, z, AbstractBomb.EFFECT_RADIUS);
    }
}
