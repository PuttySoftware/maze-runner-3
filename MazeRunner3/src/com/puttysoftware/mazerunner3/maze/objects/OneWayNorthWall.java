...
public class OneWayNorthWall extends AbstractWall {
	...
	super(false, true, true, true, false, true, true, true, ColorConstants.COLOR_BROWN,
		ObjectImageConstants.OBJECT_IMAGE_ONE_WAY_NORTH, ColorConstants.COLOR_LIGHT_RED);
    }
