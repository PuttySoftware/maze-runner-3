...
public class OneWayWestWall extends AbstractWall {
	...
	super(true, true, true, false, true, true, true, false, ColorConstants.COLOR_BROWN,
		ObjectImageConstants.OBJECT_IMAGE_ONE_WAY_WEST, ColorConstants.COLOR_LIGHT_RED);
    }
