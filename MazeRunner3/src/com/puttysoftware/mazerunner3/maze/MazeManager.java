...
import com.puttysoftware.mazerunner3.maze.games.GameLoadTask;
import com.puttysoftware.mazerunner3.maze.games.GameSaveTask;
import com.puttysoftware.mazerunner3.maze.legacy.LegacyExtension;
import com.puttysoftware.mazerunner3.maze.legacy.LegacyMazeManager;
...
public class MazeManager implements OpenFilesHandler {
	...
	if (!this.loaded) {
	    ...
	    } else if (extension.equals(LegacyExtension.getLegacyMazeExtension())
		    || extension.equals(LegacyExtension.getLegacyGameExtension())
		    || extension.equals(LegacyExtension.getLegacySavedGameExtension())) {
		this.legacy.legacyLoadFromOSHandler(file.getAbsolutePath());
	    }
	}
    }
}
