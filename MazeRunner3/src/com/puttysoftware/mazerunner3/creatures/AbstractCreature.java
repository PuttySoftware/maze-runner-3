 ...
 */
package com.puttysoftware.mazerunner3.creatures;
...
public abstract class AbstractCreature {
	...
	final long damageGiven = this.getPrestigeValue(PrestigeConstants.PRESTIGE_DAMAGE_GIVEN);
	final long damageTaken = this.getPrestigeValue(PrestigeConstants.PRESTIGE_DAMAGE_TAKEN);
	final long hitsGiven = this.getPrestigeValue(PrestigeConstants.PRESTIGE_HITS_GIVEN);
	final long hitsTaken = this.getPrestigeValue(PrestigeConstants.PRESTIGE_HITS_TAKEN);
	final long attacksDodged = this.getPrestigeValue(PrestigeConstants.PRESTIGE_ATTACKS_DODGED);
	final long missedAttacks = this.getPrestigeValue(PrestigeConstants.PRESTIGE_MISSED_ATTACKS);
	final long monstersKilled = this.getPrestigeValue(PrestigeConstants.PRESTIGE_MONSTERS_KILLED);
	final long spellsCast = this.getPrestigeValue(PrestigeConstants.PRESTIGE_SPELLS_CAST);
	final long timesKilled = this.getPrestigeValue(PrestigeConstants.PRESTIGE_TIMES_KILLED);
	final long timesRanAway = this.getPrestigeValue(PrestigeConstants.PRESTIGE_TIMES_RAN_AWAY);
	...
	final int value = (int) Math.sqrt(Math.ceil(
		this.getEffectedStat(StatConstants.STAT_AGILITY) * StatConstants.FACTOR_AGILITY_MAP_ACTIONS_PER_ROUND));
	...
	final int value = (int) Math.sqrt(Math.ceil(this.getEffectedStat(StatConstants.STAT_AGILITY)
	...
	result = prime * result + (this.mapAI == null ? 0 : this.mapAI.hashCode());
