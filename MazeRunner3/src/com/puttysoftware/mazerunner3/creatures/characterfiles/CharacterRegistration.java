 ...
 */
package com.puttysoftware.mazerunner3.creatures.characterfiles;
...
public class CharacterRegistration {
	...
	if (characterNames != null && characterNames.length > 0) {
	    ...
	    final String res = CommonDialogs.showInputDialog("Register Which Character?", "Register Character" + suffix,
	...
	final String res = CommonDialogs.showInputDialog("Unregister Which Character?", "Unregister Character" + suffix,
	...
	// Pick character to unregister
	final String res = CommonDialogs.showInputDialog("Remove Which Character?", "Remove Character" + suffix,
		characterNameList, characterNameList[0]);
	if (res != null) {
	    // Find character index
	    int index = -1;
