...
public class PartyMember extends AbstractCreature {
    ...
    private void loadPartyMember(final int newLevel, final int chp, final int cmp, final int newGold, final int newLoad,
	    final long newExperience, final int bookID, final boolean[] known, final long[] pres) {
    ...
    public static PartyMember readLegacy(final XLegacyDataReader worldFile) throws IOException {
