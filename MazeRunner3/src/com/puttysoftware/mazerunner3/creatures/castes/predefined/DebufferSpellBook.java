...
public class DebufferSpellBook extends SpellBook {
	...
	final Spell spell0 = new Spell(spell0Effect, 1, BattleTarget.ONE_ENEMY, SoundConstants.SOUND_UNLOCK);
	...
	final Spell spell1 = new Spell(spell1Effect, 2, BattleTarget.ONE_ENEMY, SoundConstants.SOUND_BIND);
	...
	final Spell spell2 = new Spell(spell2Effect, 3, BattleTarget.ONE_ENEMY, SoundConstants.SOUND_UNLOCK);
	...
	final Spell spell3 = new Spell(spell3Effect, 5, BattleTarget.ONE_ENEMY, SoundConstants.SOUND_UNLOCK);
	...
	final Spell spell4 = new Spell(spell4Effect, 7, BattleTarget.ONE_ENEMY, SoundConstants.SOUND_BIND);
	...
	final Spell spell5 = new Spell(spell5Effect, 11, BattleTarget.ONE_ENEMY, SoundConstants.SOUND_BIND);
	this.spells[5] = spell5;
	final Effect spell6Effect = new Effect("Attack Lock All", 10);
	spell6Effect.setEffect(Effect.EFFECT_MULTIPLY, StatConstants.STAT_ATTACK, 0, Effect.DEFAULT_SCALE_FACTOR,
		Effect.DEFAULT_SCALE_STAT);
	spell6Effect.setMessage(Effect.MESSAGE_INITIAL, "You lock all the enemies' weapons!");
	spell6Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "The enemies cannot attack!");
	spell6Effect.setMessage(Effect.MESSAGE_WEAR_OFF, "The locks break!");
	final Spell spell6 = new Spell(spell6Effect, 13, BattleTarget.ALL_ENEMIES, SoundConstants.SOUND_UNLOCK);
	...
	final Spell spell7 = new Spell(spell7Effect, 17, BattleTarget.ONE_ENEMY, SoundConstants.SOUND_UNLOCK);
