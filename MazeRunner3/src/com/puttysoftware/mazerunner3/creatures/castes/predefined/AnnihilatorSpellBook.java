...
public class AnnihilatorSpellBook extends SpellBook {
	...
	spell0Effect.setEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_HP, -2);
	...
	final Spell spell0 = new Spell(spell0Effect, 1, BattleTarget.ONE_ENEMY, SoundConstants.SOUND_COLD);
	this.spells[0] = spell0;
	final Effect spell1Effect = new Effect("Force Ball All", 1);
	spell1Effect.setEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_HP, -1);
	...
	spell1Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "All the enemies recoil, and are hurt!");
	final Spell spell1 = new Spell(spell1Effect, 2, BattleTarget.ALL_ENEMIES, SoundConstants.SOUND_COLD);
	this.spells[1] = spell1;
	final Effect spell2Effect = new Effect("Cutter Cloud", 1);
	spell2Effect.setEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_HP, -4);
	...
	final Spell spell2 = new Spell(spell2Effect, 3, BattleTarget.ONE_ENEMY, SoundConstants.SOUND_MISSED);
	this.spells[2] = spell2;
	final Effect spell3Effect = new Effect("Cutter Cloud All", 1);
	spell3Effect.setEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_HP, -2);
	spell3Effect.setScaleStat(StatConstants.STAT_LEVEL);
	spell3Effect.setMessage(Effect.MESSAGE_INITIAL, "You conjure a group of cutter clouds!");
	spell3Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "All the enemies get cut!");
	final Spell spell3 = new Spell(spell3Effect, 5, BattleTarget.ALL_ENEMIES, SoundConstants.SOUND_MISSED);
	...
	final Spell spell4 = new Spell(spell4Effect, 7, BattleTarget.ONE_ENEMY, SoundConstants.SOUND_FIREBALL);
	this.spells[4] = spell4;
	final Effect spell5Effect = new Effect("Vortex All", 1);
	spell5Effect.setEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_HP, -4);
	spell5Effect.setScaleStat(StatConstants.STAT_LEVEL);
	spell5Effect.setMessage(Effect.MESSAGE_INITIAL, "You conjure a cloud of vortices!");
	spell5Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "All the enemies are engulfed!");
	final Spell spell5 = new Spell(spell5Effect, 11, BattleTarget.ALL_ENEMIES, SoundConstants.SOUND_FIREBALL);
	this.spells[5] = spell5;
	final Effect spell6Effect = new Effect("Air Tear", 1);
	spell6Effect.setEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_HP, -8);
	...
	spell6Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "All the enemies are devastated!");
	final Spell spell6 = new Spell(spell6Effect, 13, BattleTarget.ALL_ENEMIES, SoundConstants.SOUND_WEAKNESS);
	...
	final Spell spell7 = new Spell(spell7Effect, 17, BattleTarget.ONE_ENEMY, SoundConstants.SOUND_DRAIN);
