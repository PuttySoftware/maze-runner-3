 ...
 */
package com.puttysoftware.mazerunner3.creatures.castes.predefined;
...
public class CurerSpellBook extends SpellBook {
	...
	spell0Effect.setMessage(Effect.MESSAGE_INITIAL, "You bandage up an ally's wounds!");
	spell0Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "The ally feels a little better!");
	final Spell spell0 = new Spell(spell0Effect, 1, BattleTarget.ONE_ALLY, SoundConstants.SOUND_HEAL);
	this.spells[0] = spell0;
	final Effect spell1Effect = new Effect("Bandage All", 1);
	spell1Effect.setEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_HP, 3);
	spell1Effect.setScaleStat(StatConstants.STAT_LEVEL);
	spell1Effect.setMessage(Effect.MESSAGE_INITIAL, "You bandage the wounds of all allies!");
	spell1Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "All the allies feel a little better!");
	final Spell spell1 = new Spell(spell1Effect, 2, BattleTarget.ALL_ALLIES, SoundConstants.SOUND_HEAL);
	...
	spell2Effect.setMessage(Effect.MESSAGE_INITIAL, "You magically recover an ally's stamina!");
	spell2Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "The ally feels better!");
	final Spell spell2 = new Spell(spell2Effect, 3, BattleTarget.ONE_ALLY, SoundConstants.SOUND_HEAL);
	this.spells[2] = spell2;
	final Effect spell3Effect = new Effect("Recover All", 1);
	spell3Effect.setEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_HP, 5);
	spell3Effect.setScaleStat(StatConstants.STAT_LEVEL);
	spell3Effect.setMessage(Effect.MESSAGE_INITIAL, "You magically recover the stamina of all allies!");
	spell3Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "All the allies feel better!");
	final Spell spell3 = new Spell(spell3Effect, 5, BattleTarget.ALL_ALLIES, SoundConstants.SOUND_HEAL);
	...
	final Spell spell4 = new Spell(spell4Effect, 7, BattleTarget.ONE_ALLY, SoundConstants.SOUND_HEAL);
	this.spells[4] = spell4;
	final Effect spell5Effect = new Effect("Heal All", 1);
	spell5Effect.setEffect(Effect.EFFECT_ADD, StatConstants.STAT_CURRENT_HP, 8);
	spell5Effect.setScaleStat(StatConstants.STAT_LEVEL);
	spell5Effect.setMessage(Effect.MESSAGE_INITIAL, "You heal the wounds of all allies!");
	spell5Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "All the allies feel much better!");
	final Spell spell5 = new Spell(spell5Effect, 11, BattleTarget.ALL_ALLIES, SoundConstants.SOUND_HEAL);
	...
	spell6Effect.setMessage(Effect.MESSAGE_INITIAL, "You fully heal the wounds of all allies!");
	spell6Effect.setMessage(Effect.MESSAGE_SUBSEQUENT, "All the allies feel completely refreshed!");
	final Spell spell6 = new Spell(spell6Effect, 13, BattleTarget.ALL_ALLIES, SoundConstants.SOUND_HEAL);
	...
	final Spell spell7 = new Spell(spell7Effect, 17, BattleTarget.ONE_ALLY, SoundConstants.SOUND_FOCUS);
