...
class SystemMonsterSpellBook extends SpellBook {
	...
	final Spell spell0 = new Spell(spell0Effect, 1, BattleTarget.ONE_ENEMY, SoundConstants.SOUND_SLIME);
	...
	final Spell spell2 = new Spell(spell2Effect, 3, BattleTarget.ONE_ENEMY, SoundConstants.SOUND_DRAIN);
	...
	final Spell spell3 = new Spell(spell3Effect, 5, BattleTarget.ONE_ENEMY, SoundConstants.SOUND_DRAIN);
