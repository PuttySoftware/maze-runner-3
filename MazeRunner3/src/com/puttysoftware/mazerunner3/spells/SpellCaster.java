...
public class SpellCaster {
    ...
    private static final String[] powers = new String[] { "1", "2", "3", "4", "5", "6", "7", "8", "9", "X" };
    ...
    public static boolean selectAndCastSpell(final AbstractCreature caster, final int teamID, final boolean aiEnabled,
	...
	String dialogResult = null;
	dialogResult = CommonDialogs.showInputDialog("Select a Spell Power Level", "Select Power", SpellCaster.powers,
		SpellCaster.powers[0]);
	if (dialogResult != null) {
	    int index;
    ...
    public static boolean castSpell(final Spell cast, final AbstractCreature caster, final int teamID,
    ...
    private static boolean castSpellWithPower(final Spell cast, final int power, final AbstractCreature caster,
	    final int teamID, final boolean aiEnabled, final MapBattleDefinitions battle) {
	if (cast != null) {
	    final int casterMP = caster.getCurrentMP();
    ...
    private static AbstractCreature[] resolveTarget(final Spell cast, final AbstractCreature caster, final int teamID,
	    final boolean aiEnabled, final MapBattleDefinitions battle) {
	final BattleTarget target = cast.getTarget();
