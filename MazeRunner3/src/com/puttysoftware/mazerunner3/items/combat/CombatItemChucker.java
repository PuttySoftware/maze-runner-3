...
public class CombatItemChucker {
    ...
    private static final AbstractCreature SOURCE = PartyManager.getNewPCInstance(0, 0, 0, 0, 0, "");
    ...
    public static boolean selectAndUseItem(final AbstractCreature user, final int teamID, final boolean aiEnabled,
    ...
    public static boolean useItem(final CombatItem used, final AbstractCreature user, final int teamID,
    ...
    private static AbstractCreature[] resolveTarget(final CombatItem used, final AbstractCreature user,
