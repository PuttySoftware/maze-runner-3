...
public class ItemInventory {
    ...
    void equipOneHandedWeapon(final AbstractCreature pc, final Equipment ei, final boolean useFirst,
    ...
    void equipTwoHandedWeapon(final AbstractCreature pc, final Equipment ei, final boolean playSound) {
	// Fix character load, changing weapons
	if (this.equipment[EquipmentSlotConstants.SLOT_MAINHAND] != null) {
	    pc.offsetLoad(-this.equipment[EquipmentSlotConstants.SLOT_MAINHAND].getEffectiveWeight());
	}
    ...
    void equipArmor(final AbstractCreature pc, final Equipment ei, final boolean playSound) {
	// Check for socks
    ...
    public static ItemInventory readLegacyItemInventory(final XLegacyDataReader dr) throws IOException {
